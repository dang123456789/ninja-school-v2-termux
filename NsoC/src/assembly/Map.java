...
public final class Map {
    ...
    public Map(int id, Cave cave, Dun dun, ChienTruong chienTruong, BossTuanLoc bossTuanLoc, GiaTocChien giaTocChien, LanhDiaGiaToc lanhDiaGiaToc, TuTienData tutien) {
    ...
    public void initMob() {
        ...
        else if (this.id >= 162 && this.id <= 163) {
            this.initmodhang13x();
        } else if (this.id == 112) {
            this.InitMobMapVip();
        } // Liên Hang
        else if (this.id >= 164 && this.id <= 187) {
            this.initmodlienhangdong();
        } else if (this.id == 189) {
            this.initmodmap5x();
        } else if (this.id == 190) {
            this.initmodmap6x();
...
//
    ...
    public void initmodlienhangdong() {
        byte j;
        for (j = 0; j < this.area.length; j++) {
            this.area[j].mobs.clear();
            int k = 0;
            ...
            for (i = 0; i < this.template.arMobid.length; ++i) {
                ...
                if (m.templates.id == 84 || m.templates.id == 83) { // mob
                    m.hpmax = 5000000;
                    m.hp = 5000000;
                } else if (m.templates.id == 88) { // Thủ lĩnh map hang 3z
                    m.hpmax = 50000000;
                    m.hp = 50000000;
                } else if (m.templates.id == 85 || m.templates.id == 86 || m.templates.id == 87) {
                    m.hpmax = 10000000;
                    m.hp = 10000000;
                } else if (m.templates.id == 89) {
                    m.hpmax = 100000000;
                    m.hp = 100000000;
                } else if (m.templates.id == 102 || m.templates.id == 103 || m.templates.id == 101 || m.templates.id == 100 || m.templates.id == 104) {
                    m.hpmax = 20000000;
                    m.hp = 20000000;
                } else if (m.templates.id == 105) {
                    m.hpmax = 200000000;
                    m.hp = 200000000;
                } else if (m.templates.id == 105 && this.id == 187) {
                    m.hpmax = 1000000000;
                    m.hp = 1000000000;
                } else if (m.templates.id == 120 || m.templates.id == 117 || m.templates.id == 121 || m.templates.id == 119 || m.templates.id == 118) {
                    m.hpmax = 30000000;
                    m.hp = 30000000;
                } else if (m.templates.id == 121 && this.id == 187) {
                    m.hpmax = 100000000;
                    m.hp = 100000000;
                } else if (m.templates.id == 127 || m.templates.id == 126 || m.templates.id == 123 || m.templates.id == 124 || m.templates.id == 125 || m.templates.id == 128) {
                    m.hpmax = 40000000;
                    m.hp = 40000000;
                } else if (m.templates.id == 194 || m.templates.id == 195 || m.templates.id == 193 || m.templates.id == 171 || m.templates.id == 179) {
                    m.hpmax = 100000000;
                    m.hp = 100000000;
                } else if (m.templates.id == 151 || m.templates.id == 130) {
                    m.hpmax = 200000000;
                    m.hp = 200000000;
                }
                if (m.lvboss == 3) {
                ...
                } else if (m.lvboss == 2 && m.templates.id == 151 || m.templates.id == 71 || m.templates.id == 69) {
                    m.hpmax = 1000000000;
                    m.hp = 1000000000;
                } else if (m.lvboss == 1) {
                    n = m.hpmax * 5;
            ...
            if (i == area) {
                ...
                for (j = 0; j < tileMap.mobs.size(); ++j) {
                    ...
                    if (mob != null && mob.status == 0 && mob.isboss) {
                        ...
                        System.out.println("Boss Open : " + mob.templates.name);
                    }
                }
                break;
            }
...
public boolean TruyenThuyet() {
        return this.id ==195;
    }
//        public boolean TruyenThuyet() {
//        return this.id >= 160 && this.id <= 194;
//    }
    private void update() {
        byte i;
        for (i = 0; i < this.area.length; ++i) {
