...
import ItemLeave.Boss;
import ItemLeave.MapBinhThuong;
import ItemLeave.SuKien;
...
public class Mob {
    ...
    public void updateHP(int num, int _charId, boolean liveAttack) {
        ...
        if (this.hp <= 0) {
            ...
            this.isDie = true;
            if (this.isRefresh) {
                this.timeRefresh = System.currentTimeMillis() + 25000;
            }
...
//            int master = this.sortNinjaFight();
            ...
            if (Math.abs(this.level - _char.get().level) <= 10 || this.tileMap.map.LangCo() || this.tileMap.map.mapChienTruong()) {
                ...
                if (Server.manager.event != 0 && this.tileMap.map.id != 161 && !this.tileMap.map.LangCo() && this.tileMap.map.id != 112 && this.tileMap.map.id != 192) { // không phải bằng 0
                    SuKien.leaveItemSuKien(this.tileMap, this, master);
                }
                switch (Util.nextInt(1, 2)) {
                    case 1: {
                        if (this.lvboss == 0 && Util.nextInt(30) < 5) { // tỉ lệ rơi yên
                            ItemLeave.leaveYen(this.tileMap, this, master);
                        }
                        break;
                    }
                    case 2: {
                        if (Util.nextInt(50) < 10) {
                            MapBinhThuong.leaveItemmapngoai(this.tileMap, this, master);
                        }
                        break;
                    }
                }
            }
            if (_char.get().getEffId(44) != null && Math.abs(this.level - _char.get().level) <= 10) {
//                _char.p.c.upxuMessage(10);
//                _char.p.upluongMessage(1);
                ItemLeave.randomLeavenlxd(this.tileMap, this, master, 1, 0);
            }
            if (this.tileMap.map.VDMQ() && (_char.get().getEffId(40) != null || _char.get().getEffId(41) != null) && Math.abs(this.level - _char.get().level) <= 10) { // tnp
                ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 0);
                 _char.p.c.upxuMessage(100);
                 _char.p.upluongMessage(1);
            } else if (this.tileMap.map.LangCo()) {
                ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 1);
                    _char.p.upluongMessage(3);
                    _char.p.c.upxuMessage(331);
            } else if (this.tileMap.map.huyenthoai()) {
                ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 2);
                _char.p.upluongMessage(4);
                _char.p.c.upxuMessage(511);
            } else if (this.tileMap.map.langshiba() && Math.abs(this.level - _char.get().level) <= 10) {
                ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 3);
                _char.p.upluongMessage(3);
                _char.p.c.upxuMessage(100);
            } else if (this.tileMap.map.id == 198) { // Map truyền thuyết
                ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 4);
                _char.p.upluongMessage(10);
                _char.p.c.upxuMessage(5000);
                } else if (this.tileMap.map.id == 112) { // Map truyền thuyết
                    ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 1);
                ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 4);
                _char.p.upluongMessage(60);
                _char.p.c.upxuMessage(40000);
                 } else if (this.tileMap.map.id == 199) { // Map truyền thuyết
                     ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 1);
                ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 10), 4);
                _char.p.upluongMessage(60);
                _char.p.c.upxuMessage(40000);
                } else if (this.tileMap.map.id == 197) { // Map truyền thuyết
                    ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 1);
                ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 10), 4);
                _char.p.upluongMessage(60);
                _char.p.c.upxuMessage(40000);
            } else if (this.tileMap.map.id == 192) { // Map tu tiên
                ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 5);
                ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 10), 4);
                ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 1);
         } else if (this.tileMap.map.id == 196) { // Map truyền thuyết
                     ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 1);
                ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 10), 4);
                _char.p.upluongMessage(60);
                _char.p.c.upxuMessage(40000);
              ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 5);
              } else if (this.tileMap.map.id == 208) { // Map truyền thuyết
                     ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 1);
                ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 10), 4);
                _char.p.upluongMessage(60);
                _char.p.c.upxuMessage(40000);
                } else if (this.tileMap.map.id == 202) { // Map truyền thuyết
                     ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 1);
                ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 10), 4);
                _char.p.upluongMessage(100);
                _char.p.c.upxuMessage(100000);
              ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 5);
              } else if (this.tileMap.map.id == 207) { // Map truyền thuyết
                     ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 1);
                ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 10), 4);
                _char.p.upluongMessage(60);
                _char.p.c.upxuMessage(40000);
              ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 5);
            } else if (this.tileMap.map.id == 200) { // Map truyền thuyết
                     ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 1);
                ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 10), 4);
               _char.p.upluongMessage(200000);
                _char.p.c.upxuMessage(10111111);
              ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 5);
              } else if (this.tileMap.map.id == 201) { // Map truyền thuyết
                     ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 1);
                ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 10), 4);
               _char.p.upluongMessage(1000000);
                _char.p.c.upxuMessage(200000000);
              ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 5);
              } else if (this.tileMap.map.id == 204) { // Map truyền thuyết
                     ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 1);
                ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 10), 4);
               _char.p.upluongMessage(200000);
                _char.p.c.upxuMessage(10111111);
              ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 5);
              } else if (this.tileMap.map.id == 209) { // Map truyền thuyết
                     ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 1);
                ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 10), 4);
               _char.p.upluongMessage(200000);
                _char.p.c.upxuMessage(10111111);
              ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 5);
              } else if (this.tileMap.map.id == 211) { // Map truyền thuyết
                     ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 4), 1);
                ItemLeave.randomLeave(this.tileMap, this, master, Util.nextInt(1, 10), 4);
                _char.p.upluongMessage(200000);
                _char.p.c.upxuMessage(10111111);
            ...
            if (this.isboss) {
                if (this.tileMap.map.cave == null) {
                    ...
                    switch (this.templates.id) {
                        case 160:
                            Boss.ItemBossSuKien(this.tileMap, this, master);
                            break;
                        case 210:
                            Boss.ItemBossTruyenThuyet(this.tileMap, this, master);
                            break;
                        default:
                            Boss.ItemBossThuong(this.tileMap, this, master);
                            break;
                    }
                }
                if (this.tileMap.map.VDMQ()) {
                    Service.chatKTG(_char.name + " đã tiêu diệt " + this.templates.name + " Tại Vùng Đất Ma Quỷ ");
                    int i;
                    for (i = 0; i < 10; i++) {
                        ItemLeave.leaveYen(this.tileMap, this, master);
                    }
                    Boss.ItemBossVDMQ(this.tileMap, this, master);
                }
                if (this.tileMap.map.LangCo()) {
                    Service.chatKTG(_char.name + " đã tiêu diệt " + this.templates.name + " Tại Làng Cổ");
                    int i;
                    for (i = 0; i < 10; i++) {
                        ItemLeave.leaveYen(this.tileMap, this, master);
                    }
                    Boss.ItemBossLC(this.tileMap, this, master);
                }
