...
// sửa
    ...
    public int quantityItemyTotalBox(final int id) {
        int quantity = 0;
    ...
    public boolean addItemBag(Boolean uptoup, Item itemup) {
        try {
            ...
            if (uptoup && !itemup.isExpires && ItemTemplate.ItemTemplateId(itemup.id).isUpToUp && index != -1) {
                ...
                int check = item.quantity + itemup.quantity + this.quantityItemyTotalBox(item.id);
                if (check >= 30000) {
                    p.conn.sendMessageLog("Số lượng item đã đầy");
                    return false;
                }
        ...
        try {
            synchronized (Server.LOCK_MYSQL) {
                ...
                if (red != null && red.first()) {
                    ...
                    nja.topvebua = red.getInt("topvebua");
                    nja.leveltutien = red.getShort("leveltutien");
                    nja.exptutien = red.getLong("exptutien");
                    nja.nhanquavip = red.getInt("nhanquavip");
                    nja.diemnap = red.getInt("diemnap");
                    nja.setmaxtnp = red.getInt("setmaxtnp");
                    nja.levelhouse = red.getShort("levelhouse");
                    nja.tntrung = red.getInt("tntrung");
                    nja.kntrung = red.getInt("kntrung");
                    nja.nhantiennha = red.getShort("nhantiennha");
                    ...
                    jar = (JSONArray) JSONValue.parse(red.getString("thuctinh"));
                    nja.Non = Integer.parseInt(jar.get(0).toString());
                    nja.VuKhi = Integer.parseInt(jar.get(1).toString());
                    nja.Ao = Integer.parseInt(jar.get(2).toString());
                    nja.DayChuyen = Integer.parseInt(jar.get(3).toString());
                    nja.Gang = Integer.parseInt(jar.get(4).toString());
                    nja.Nhan = Integer.parseInt(jar.get(5).toString());
                    nja.Quan = Integer.parseInt(jar.get(6).toString());
                    nja.Boi = Integer.parseInt(jar.get(7).toString());
                    nja.Giay = Integer.parseInt(jar.get(8).toString());
                    nja.Bua = Integer.parseInt(jar.get(9).toString());
                    ...
                    jar = (JSONArray) JSONValue.parse(red.getString("sk_tet"));
                    nja.isNhanQuaTet = Integer.parseInt(jar.get(0).toString());
    ...
    public void flush() {
        ...
        try {
            synchronized (Server.LOCK_MYSQL) {
                ...
                jarr.add(this.Giay);
                jarr.add(this.Bua);
                sqlSET = sqlSET + ",`thuctinh`='" + jarr.toJSONString() + "'";
                jarr.clear();
                jarr.add(this.pheCT);
                ...
                jarr.clear();
                jarr.add(this.isNhanQuaTet);
                sqlSET = sqlSET + ",`sk_tet`='" + jarr.toJSONString() + "'";
                ...
                sqlSET = sqlSET + ",`eventPoint`=" + eventPoint
                        ...
                        + ",`top`=" + this.top
                        + ",`vip`=" + this.vip
                        + ",`topvebua`=" + this.topvebua
                        + ",`leveltutien`=" + this.leveltutien
                        + ",`nhanquavip`=" + this.nhanquavip
                        + ",`diemnap`=" + this.diemnap
                        + ",`setmaxtnp`=" + this.setmaxtnp
                        + ",`levelhouse`=" + this.levelhouse
                        + ",`nhantiennha`=" + this.nhantiennha
                        + ",`exptutien`=" + this.exptutien + ""
                        + ",`tntrung`=" + this.tntrung + ",`kntrung`=" + this.kntrung
...
//               item.options.get(i).id == 85 &&
//               item.options.get(i).param >=9 &&
               item.upgrade >= 12){
               this.ItemTN[i]=item;
                i++;
                }
