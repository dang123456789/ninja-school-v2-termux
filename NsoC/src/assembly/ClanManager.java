...
public class ClanManager {
        ...
        try {
            ...
            if (p.c.clan.typeclan != 4 && mem != null) {
                ...
                if (coinDown > p.c.xu) {
                    ...
                    p.setTypeClan(-1);
                    LichSu.LichSuXu(p.c.name, p.c.xu, p.c.xu - coinDown, " Rời Khỏi Gia Tộc", -coinDown);
        ...
        try {
            ...
            if (inputcoin > 0) {
                ...
                this.updateCoin(inputcoin);
                 LichSu.LichSuXu(p.c.name, p.c.xu, p.c.xu - inputcoin, " Góp Vào Gia Tộc", - inputcoin);
    ...
    public static void createClan(Player p, String name) {
        ...
        if (p.luong < 100000) {
            p.conn.sendMessageLog("Bạn cần có 100.000 lượng để thành lập gia tộc");
            return;
        }
                ...
                if (clan != null) {
                    ...
                    try {
                        synchronized (Server.LOCK_MYSQL) {
                            ...
                            clan.flush();
                            p.c.flush();
                            LichSu.LichSuLuong(p.c.name, p.luong, p.luong - 100000, " Lập Gia Tộc", - 100000);
                            p.upluong(-100000L);
                            ...
                            p.setTypeClan(4);
                            red.close();
                            Service.chatNPC(p, (short) 0, "Chúc mừng con đã thành lập gia tộc mới.");
                        }
