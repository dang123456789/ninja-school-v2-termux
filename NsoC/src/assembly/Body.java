...
public class Body {
    ...
    public int getMaxHP() {
        ...
        hpmax += hpmax * (this.getPramItem(31) + this.getPramItem(61) + this.getPramSkill(17)) / 150;
    ...
    public long dameSide() {
        ...
        if (eff != null) {
            si += this.getPramItem(38) * eff.param / 150;//buff tan cong co ban cua long luc dan
        }
        return si;
    }
...
//        exa += this.getPramItem(75);
    ...
    public int Miss() {
        ...
        miss += this.getPotential(1) * 100 / 500;
...
//        rd += this.getPramItem(15);
    ...
    public int getPotential(int i) {
        ...
        potential = potential * (100 + this.getPramItem(58)) / 500;
