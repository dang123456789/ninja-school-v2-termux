...
public class LanhDiaGiaToc {
    ...
    private void initMap() {
        this.map[0] = new Map(80, null, null, null, null, null, this, null);
        this.map[1] = new Map(81, null, null, null, null, null, this, null);
        this.map[2] = new Map(82, null, null, null, null, null, this, null);
        this.map[3] = new Map(83, null, null, null, null, null, this, null);
        this.map[4] = new Map(84, null, null, null, null, null, this, null);
        this.map[5] = new Map(85, null, null, null, null, null, this, null);
        this.map[6] = new Map(86, null, null, null, null, null, this, null);
        this.map[7] = new Map(87, null, null, null, null, null, this, null);
        this.map[8] = new Map(88, null, null, null, null, null, this, null);
        this.map[9] = new Map(89, null, null, null, null, null, this, null);
        this.map[10] = new Map(90, null, null, null, null, null, this, null);
    }
                ...
                synchronized (this.ninjas) {
                    ...
                    for (i = 0; i < this.ninjas.size(); ++i) {
                        ...
                        if (_char != null) {
                            ...
                            _char.p.upluongMessage(clanManager.level * 100);
                            LichSu.LichSuLuong(_char.name, _char.p.luong, clanManager.level * 100, " Nhận Quà Win Lãnh Địa Gia Tộc", clanManager.level * 100);
                            _char.addItemBag(false, ItemTemplate.itemDefault(ItemName.CHIA_KHOA_VE_BUA));
