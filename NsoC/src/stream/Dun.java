...
public class Dun {
    ...
    Server server;
    public static final ArrayList<Dun> entrys = new ArrayList<Dun>();
    ...
    private void initMap() {
        this.map[0] = new Map(133, null, this, null, null, null, null, null);
        this.map[1] = new Map(111, null, this, null, null, null, null, null);
    }
            ...
            synchronized (this) {
                ...
                if (this.c1 == null && this.c2 != null) { //nếu người chơi c1 thoát
                    if (this.tienCuocTeam2 > 0) { //nếu người chơi c2 có tiền cược => trả lại tiền cược
                        LichSu.LichSuXu(c2.c.name, c2.c.xu, c2.c.xu + (int) tienCuocTeam2, " Cộng Tiền Lôi Đài", +(int) tienCuocTeam2);
                    ...
                    if (this.tienCuocTeam1 != 0) { //nếu người chơi c1 có đặt tiền cược và thoát => trả lại
                        ...
                        if (checkChar == null) { //ko online
                            ...
                            LichSu.LichSuXu(checkChar.c.name, checkChar.c.xu, checkChar.c.xu + (int) tienCuocTeam1, " Cộng Tiền Lôi Đài", +(int) tienCuocTeam1);
                    ...
                    if (this.tienCuocTeam1 > 0) {
                        LichSu.LichSuXu(c1.c.name, c1.c.xu, c1.c.xu + (int) tienCuocTeam1, " Cộng Tiền Lôi Đài", +(int) tienCuocTeam1);
                    ...
                    if (this.tienCuocTeam2 != 0) {
                        ...
                        if (checkChar == null) {
                            ...
                            LichSu.LichSuXu(checkChar.c.name, checkChar.c.xu, checkChar.c.xu + (int) tienCuocTeam2, " Cộng Tiền Lôi Đài", +(int) tienCuocTeam2);
