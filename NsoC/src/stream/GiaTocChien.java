...
public class GiaTocChien {
    ...
    private void initMap() {
        this.map[0] = new Map(117, null, null, null, null ,this, null, null);
        this.map[1] = new Map(118, null, null, null, null ,this, null, null);
        this.map[2] = new Map(119, null, null, null, null ,this, null, null);
        this.map[3] = new Map(120, null, null, null, null ,this, null, null);
        this.map[4] = new Map(121, null, null, null, null ,this, null, null);
        this.map[5] = new Map(122, null, null, null, null ,this, null, null);
        this.map[6] = new Map(123, null, null, null, null ,this, null, null);
        this.map[7] = new Map(124, null, null, null, null ,this, null, null);
    }
                        ...
                        if(_char != null) {
                            if(this.start) {
                                if(this.clanWin == null) {
                                    ...
                                    Service.chatKTG("Gia tộc " + this.clanWin.name  + " đã chiến thắng gia tộc " + this.clanLoss.name  + " trong gia tộc chiến.");
